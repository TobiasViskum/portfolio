  ...
  return (
    <PageWrapper>
      ...
      <SectionLayout1 title="Om dette projekt">
        ...
        Først blev appen lavet med den idé, at man skulle kunne tracke sine
        fremskridt i fitness. Senere udviklede appen sig også til, at man kunne
        tracke sin cardio progress.
        <br />
        <br />
        Appen er gået igennem to store rewrites, og derfor er der en version 2
        og 3. De to rewrites har handlet om UI, skift fra Javascript til
        Typescript, omskrivning i et andet framework, ændring af hvordan
        frontend og backend virker sammen og skift fra standard CSS til
        Tailwind. Under kan der læses videre om de tre forskellige versioner.
      </SectionLayout1>
